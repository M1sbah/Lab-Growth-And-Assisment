...
router.get('/',async(req,res)=>{
    ...
    let data=await MrkSht.find({});

    res.render('MarkSheet',{title:'Marksheet',data:data})
});

router.post('/viewsheet',async(req,res)=>{
    ...
    res.render("ViewAnswerSheet",{title:'Answersheet',data:sheet,paperID:pid,email:email,subject:subject,username:username});
